...
class Orders{
  ...
  init(Function(List<OrdersData>, String) callback, Function(String) _onError){
    if (account.isAuth())
      if (data != null)
        callback(data, currency);
      getOrders(account.token, (List<OrdersData> _data, String _currency) {
        data = _data;
        currency = _currency;
        callback(_data, currency);
      }, _onError);
  }
}