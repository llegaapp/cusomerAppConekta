...
changeProfile(String uid, String name, String email, String phone,String rfc,String businessName,
  ...
  try {
    ...
    String body = '{"name" : ${json.encode(name)}, "email": ${json.encode(email)}, "phone": ${json.encode(phone)}, "rfc": ${json.encode(rfc)}, "businessName": ${json.encode(businessName)}}';
